...
class DeliveryStep
{
    ...
    public function getStep($campaignId)
    {
        ...
        if ($campaign->start_time == null) {
            ...
            $deliveryObj->dateTime->start->hours = (int)explode(":", explode(" ", $campaign->start_time)[1])[0];
            $deliveryObj->dateTime->start->mints = (int)explode(":", explode(" ", $campaign->start_time)[1])[1];
        }
        ...
        if ($campaign->end_time == null) {
            ...
            $deliveryObj->dateTime->end->hours = (int)explode(":", explode(" ", $campaign->end_time)[1])[0];
            $deliveryObj->dateTime->end->mints = (int)explode(":", explode(" ", $campaign->end_time)[1])[1];
        }
