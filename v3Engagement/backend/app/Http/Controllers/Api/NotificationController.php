...
class NotificationController extends Controller
{
    ...
    public function sendNotification()
    {
        try {
            ...
            $notificationBuilder = new PayloadNotification($this->notification['title']);
            $notificationBuilder->setBody($this->notification['body'])
                ...
                ->setLink($this->notification['link']);
            ...
            $downstreamResponse = (new SendNotification(new HttpClient(), $url))->sendTo($token, $option, $notification, $data);
