...
class CompanyController extends Controller
{
    ...
    public function userDelete(String $version, AppUsers $id)
    {
        return $this->resourceClass->remove($id);
    }

    public function userStatus(Request $request, String $version, AppUsers $id)
    {
