...
//            $this->saveNotification($data, $response);
        } catch (\Exception $exception) {
            Log::info('Response payload at exception: ' . \GuzzleHttp\json_encode($payload));
            $this->trackingLogsFailedEmail($exception, $payload);
            $response = array(
                'status' => 'error',
                'data' => [],
