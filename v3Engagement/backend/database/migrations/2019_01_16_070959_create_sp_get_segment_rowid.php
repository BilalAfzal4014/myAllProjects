...
class CreateSpGetSegmentRowid extends Migration
{
    ...
    public function up()
    {
        ...
        Db::connection()->getPdo()->exec("CREATE DEFINER=`$config_database_definer` @`%` PROCEDURE `$procedureName` (IN segment_id INT) BEGIN 
...
SET main_sql=\"SELECT row_id FROM (SELECT r0.row_id,r0.company_id,sg.id  [COLUMN_VALUE]\"; 
...
SET main_sql=CONCAT(main_sql,\" GROUP BY r0.row_id \"); 
