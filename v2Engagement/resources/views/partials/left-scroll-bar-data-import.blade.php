        ...
        <ul>
            ...
            <li>
                <div class="db_list_left_sublist">
                    <h3>Status</h3>
                    <ul>
                        <li><a class="filter-status" href="javascript:void(0);" data-action="pending">Pending</a></li>
                        <li><a class="filter-status" href="javascript:void(0);" data-action="inprocess">In Process</a>
                        <li><a class="filter-status" href="javascript:void(0);" data-action="completed">Completed</a></li>
                        </li>
                    </ul>
                </div>
            </li>
