<template>
  <div class="nationality-field-box mr-1">
    <div class="nationality group">
      <label for="nationality">Nationality</label>
      <select id="nationality" name="nationality" @change="changeNationality">
        <option value="">
          Select Nationality
        </option>
        <option v-for="nationality in nationalities" :key="nationality.key" :value="nationality.key" :selected="nationality.key === country">
          {{ nationality.value }}
        </option>
      </select>
