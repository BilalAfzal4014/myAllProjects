    ...
    <div class="legal-content-body-outer-box">
      <div class="sidebar-item-content-box">
        ...
        <div id="section-01">
          ...
          <ul class="section-title-list">
            <li class="section-title-item">
              <strong>Agreement</strong>. This Agreement is a binding legal agreement between you and the applicable Core Direction Entity indicated in Section 14.4 below (“<strong>Core Direction</strong>”, “<strong>we</strong>”, “<strong>us</strong>” or “<strong>our</strong>”). If you enter into this Agreement on behalf of a company or other legal entity, you represent and warrant that you have the legal authority to bind that entity and its Affiliates to this Agreement, and all references to <strong>“you”</strong> and <strong>“your”</strong> in this Agreement are referring to that entity. You and Core Direction are also sometimes referred to in this Agreement individually as a <strong>“Party”</strong> and collectively as the <strong>“Parties”</strong>.
            </li>
            <li class="section-title-item">
              Our Privacy Policy is also part of this Agreement.
            </li>
            <li class="section-title-item">
              Our <a class="external-link" href="#" target="_blank">Privacy Policy</a> explains how we collect and use information that’s submitted to the Services. By using the Services, you are indicating that you’ve read the <a class="external-link" href="#" target="_blank">Privacy Policy</a> and agree to its terms.
            </li>
            <li class="section-title-item">
            ...
            <li class="section-title-item">
              This Agreement applies to any use of the Services, whether in connection with a paid subscription or a free trial. For clarity, this Agreement does not apply to use of the Core Direction white label web-app. That has a separate agreement, which is accessible through the Core Direction Web-app. In addition, if you (or any third party on your behalf) uses our APIs, you will be subject to the applicable API terms set forth at <a class="external-link" href="https://developers.coredirection.com/Resources/DeveloperAgreement" target="_blank">https://developers.coredirection.com/Resources/DeveloperAgreement</a> (or such other URL as specified by Core Direction), as may be updated by Core Direction from time to time and/or any other terms designated by Core Direction.
            </li>
            <li class="section-title-item">
              Certain additional terms apply to personal information that originates from the EU, UK, or pertains to CA residents.
            </li>
            <li class="section-title-item">
              To the extent that Core Direction processes Your Data originating from the European Economic Area, or the United Kingdom, or with respect to Personal Information (defined within the <a class="external-link" href="#" target="_blank">Privacy Annex</a>) that is processed on behalf of you which relates to residents of the State of California, the terms of the <a class="external-link" href="#" target="_blank">Privacy Annex</a> apply between the Parties.
            </li>
            <li class="section-title-item">
            ...
            <li class="section-title-item">
              <strong>Changes to the Agreement</strong>. We may, in our sole discretion, make changes to this Agreement from time to time. Any changes we make will become effective when we post a modified version of the Agreement to <a class="external-link" href="#" target="_blank">https://company.coredirection.com/legal/terms-of-service</a> (or such other URL as specified by Core Direction), as may be updated by Core Direction from time to time, and we agree the changes will not be retroactive. If we make any material changes to the Agreement, we’ll also notify you within the Software Service or by sending you an email. If you continue using the Services after any changes, it means you have accepted them. If you do not agree to any changes, you must stop using the Services, and you can terminate your account by submitting a <a class="external-link" href="https://support.coredirection.com/s/contactsupport" target="_blank">Support Request</a>. It is your obligation to ensure that you read, understand and agree to the latest version of the Agreement. The legend at the top of the Agreement indicates when it was last changed.
            </li>
            <li class="section-title-item">
              Additional terms apply to certain products that we provide
            </li>
            <li class="section-title-item">
              <strong>Supplemental Terms</strong>. Your use of, and participation in, certain Services may be subject to additional terms (“<strong>Supplemental Terms</strong>”) and such Supplemental Terms will either be listed in this Agreement or will be presented to you for your acceptance when you sign up to use the supplemental Service. If this Agreement is inconsistent with the Supplemental Terms, the Supplemental Terms will control with respect to the service with which it applies.
            </li>
          </ul>
        </div>
        <div id="section-02">
          ...
          <ul class="section-title-list">
            ...
            <li class="section-title-item">
              <strong>Support Services</strong>. As part of the Services you will have access to Core Direction’s standard support services described at <a class="external-link" href="https://support.coredirection.com/s/article/Standard-Support-Services" target="_blank" rel="noopener noreferrer">https://support.coredirection.com/s/article/Standard-Support-Services</a> (or such other URL as specified by Core Direction), as may be updated by Core Direction from time to time.
            </li>
            <li class="section-title-item">
            ...
            <li class="section-title-item">
              <strong>Marketing Services</strong>. When you subscribe to our Software Service, your business will be provided the opportunity to be listed on the Marketing Services. From time to time, Core Direction may offer subscribers the opportunity to participate in promotional programs (“Core Direction Promote”), which are designed to promote their businesses and attract customers through the Marketing Services. To enroll in Core Direction Promote, you must review and agree to the applicable Core Direction Promote terms and conditions accessible at <a class="external-link" href="#" target="_blank" rel="noopener noreferrer">/legal/terms-of-service/promote-terms</a> (or such other URL as specified by Core Direction) (“Core Direction Promote Terms”). Core Direction reserves the right to charge fees for Core Direction Promote in accordance with the Core Direction Promote Terms. If you enroll in Core Direction Promote, you agree to pay all applicable fees for Core Direction Promote in accordance with Section 4.2 of this Agreement. In the event of any conflict between this Agreement and the Core Direction Promote Terms, the Core Direction Promote Terms will apply.
            </li>
            <li class="section-title-item">
            ...
            <li class="section-title-item">
              <strong>Free, Trial and Beta Services</strong>. Core Direction may in its sole discretion offer free, trial or beta Services from time to time at no charge. Notwithstanding anything to the contrary herein: (a) any free, trial or beta Services are provided “AS IS” with no warranties of any kind; and (b) Core Direction may discontinue any free, trial or beta Services or your ability to use such Services at any time, with or without notice and without any further obligations to you. Without limiting the generality of the foregoing, free Services that have not been accessed or used for 12 consecutive months may be terminated by us. Core Direction will have no liability for any harm or damages suffered by you or any third party in connection with any free, trial or beta Services.
            </li>
            <li class="section-title-item">
              Additional terms apply to the purchase of professional services.
            </li>
            <li class="section-title-item">
              <strong>Professional Services Terms</strong>. Additional terms specific to the procurement of <a class="external-link" href="#" target="_blank" rel="noopener noreferrer">Professional Services</a> apply and are hereby incorporated by reference into this Agreement as if set forth fully herein.
            </li>
            <li class="section-title-item">
              Additional terms apply to the white labeled web-app.
            </li>
            <li class="section-title-item">
              <strong>Whitel Labeled Web-app Terms</strong>. Additional terms specific to the procurement of the <a class="external-link" href="#" target="_blank" rel="noopener noreferrer">White Labeled Web-app</a> apply and are hereby incorporated by reference into this Agreement as if set forth fully herein.
            </li>
            <li class="section-title-item">
              Additional terms apply to the purchase and use of heart rate monitors, receivers, payment enabling, and other hardware.
            </li>
            <li class="section-title-item">
              <strong>Hardware Terms</strong>. Additional terms specific to the procurement and use of <a class="external-link" href="#" target="_blank" rel="noopener noreferrer">heart rate monitors, receivers, payment enabling, and other similar hardware</a> apply and are hereby incorporated by reference into this Agreement as if set forth fully herein.
            </li>
            <li class="section-title-item">
              Additional terms apply to the purchase and use of a smart payment terminal device.
            </li>
            <li class="section-title-item">
              <strong>Smart Payment Terminal Terms</strong>. Additional terms specific to the use of <a class="external-link" href="#" target="_blank" rel="noopener noreferrer">Smart Payment Terminals</a> apply and are hereby incorporated by reference into this Agreement as if set forth fully herein.
            </li>
            <li class="section-title-item">
              Additional terms apply for payment processing services.
            </li>
            <li class="section-title-item">
              <strong>Payment Processing</strong>. Core Direction offers the ability to process payments through the Services (“Payment Processing Services”). Payment Processing Services are provided by our third party payment processing partners as Third Party Offerings and any procurement by you or your Affiliates will be subject to a separate merchant agreement which will be solely between you (or your Affiliate) and the third party processor. If you use Payment Processing Services you agree that you and your Affiliates will comply with the terms and conditions of any applicable merchant agreements and all applicable card network rules, policies, laws and regulations, at all times while using such Payment Processing Services.
              At Core Direction's sole discretion, you may be offered Payment Processing Services provided by Stripe (“Core Direction Payments”). Core Direction Payments are subject to the <a class="external-link" href="https://stripe.com/connect-account/legal" target="_blank" rel="noopener noreferrer">Stripe Connected Account Agreement</a>, which includes the <a class="external-link" href="https://stripe.com/legal" target="_blank" rel="noopener noreferrer">Stripe Terms of Service</a> (collectively, the “Stripe Services Agreement”) and subject to certain fees and surcharges communicated to you during the enrollment process and as may be updated by Core Direction from time to time. By enrolling in Core Direction Payments, you agree to be bound by the Stripe Services Agreement, as the same may be modified by Stripe from time to time. As a condition of Core Direction enabling Payment Processing Services through Stripe, you agree to provide Core Direction accurate and complete information about you and your business, and you authorize Core Direction to share it and transaction information related to your use of the Payment Processing Services provided by Stripe pursuant to our <a class="external-link" href="https://stripe.com/legal" target="_blank" rel="noopener noreferrer">Privacy Policy</a>. To the extent permitted by law, we may collect any obligations you owe us under this Agreement by deducting the corresponding amounts from funds payable to you arising from the settlement of card transactions through Core Direction Payments. Fees will be assessed at the time a transaction is processed and will be first deducted from the funds received for such transactions. If the settlement amounts are not sufficient to meet your obligations to us, we may charge or debit the bank account or credit card registered in your account for any amounts owed to us. In the event a consumer chargeback or dispute occurs, you may be charged up to fifteen dollars ($15) per occurrence by Core Direction. Your failure to fully pay amounts that you owe us on demand will be a breach of this Agreement. You will be liable for our costs associated with collection in addition to the amount owed, including without limitation attorneys' fees and expenses, costs of any arbitration or court proceeding, collection agency fees, and any applicable interest. Additionally, we may require a personal guarantee from a principal of a business for funds owed under this Agreement. If we require a personal guarantee we will specifically inform you. In addition to the amount due, delinquent accounts may be charged with fees that are incidental to the collection of delinquent accounts and chargebacks including, but not limited to, collection fees and convenience fees and other third parties charges. You hereby explicitly agree that all communication in relation to delinquent accounts will be made by electronic mail or by phone, as provided to Core Direction by you. Such communication may be made by Core Direction or by anyone on its behalf, including but not limited to a third party collection agent.
              Core Direction may offer special pricing, credits, and/or discounts to you or your Affiliates for the Services contingent upon timely procurement, and continued material usage, of the Payment Processing Services and/or Core Direction Payments. In the event you or your Affiliate stop utilizing the Payment Processing Services and/or Core Direction Payments, Core Direction may, in its sole discretion, revoke the special pricing, credits, and/or discounts being applied to the Services.
            </li>
            <li class="section-title-item">
              Additional terms apply to the use of the Virtual Wellness Platform.
            </li>
            <li class="section-title-item">
              <strong>Virtual Wellness Platform</strong>. Additional terms specific for the procurement of the <a class="external-link" href="#" target="_blank" rel="noopener noreferrer">Virtual Wellness Platform</a> apply and are hereby incorporated by reference into this Agreement as if set forth fully herein.
            </li>
            <li class="section-title-item">
              Additional terms apply to the use of the Partner Store.
            </li>
            <li class="section-title-item">
              <strong>Partner Store</strong>. Additional terms specific for the procurement of the <a class="external-link" href="#" target="_blank" rel="noopener noreferrer">Partner Store</a> apply and are hereby incorporated by reference into this Agreement as if set forth fully herein.
            </li>
            <li class="section-title-item">
              Additional terms apply to the use of the Franchise Fees Tool.
            </li>
            <li class="section-title-item">
              <strong>Franchise Fees Tool</strong>. Additional terms specific to the use of the <a class="external-link" href="#" target="_blank" rel="noopener noreferrer">Franchise Fees Tool</a> apply and are hereby incorporated by reference into this Agreement as if set forth fully herein.
            </li>
          </ul>
        </div>
        <div id="section-03">
        ...
        <div id="section-04">
          ...
          <ul class="section-title-list">
            <li class="section-title-item">
              <strong>Software Services Fees</strong>. Unless otherwise stated on an Order Form, fees for the Software Services (“Subscription Fees”) are set forth on the applicable Website(s).
            </li>
            <li class="section-title-item">
        ...
        <div id="section-05">
          ...
          <ul class="section-title-list">
            ...
            <li class="section-title-item">
              <strong>License Grant to Core Direction</strong>. You hereby grant to Core Direction and its affiliates a worldwide, perpetual, irrevocable, transferable, sublicensable, royalty-free license to (a) modify, copy, distribute and incorporate into the Services (without attribution of any kind) any suggestions, enhancement request, recommendations, proposals, correction or other feedback or information provided by you, Affiliates or End Users relating to the Services or Core Direction’s or its affiliates’ business(es); and (b) to use your business name(s), trademarks, service marks, logos or any publicly available images (collectively, “<strong>Your Marks</strong>”) in connection with: (x) providing the Services, (y) for marketing and promotional purposes in connection with Core Direction’s business, and (z) for Marketing Services. Core Direction agrees that any use by Core Direction of any of Your Marks will insure solely to the benefit and goodwill of your business. Other than those rights specifically granted to Core Direction or its affiliates herein, all right, title and interest in and to Your Marks are expressly reserved by you.
            </li>
          </ul>
        </div>
        <div id="section-06">
          ...
          <ul class="section-title-list">
            <li class="section-title-item">
              <strong>Your Data</strong>. As between you and Core Direction, you own all right, title and interest in Your Data. You hereby grant to Core Direction a nonexclusive, worldwide, assignable, sublicensable, fully paid-up and royalty-free license and right to copy, distribute, display and perform, publish, prepare derivative works of and otherwise use Your Data for the purposes of providing, improving and developing Core Direction’s or its affiliates’ products and services and/or complementary products and services of our partners. You represent and warrant to Core Direction that you have all rights necessary to grant the licenses in this Section 6.1, and that your provision and use of Your Data through and in connection with the Services does not violate any applicable laws or rights of any third party.
            </li>
            <li class="section-title-item">
              We own data that we collect through independent sources, like the Core Direction Web-app.
            </li>
            <li class="section-title-item">
              <strong>Core Direction Data</strong>. Notwithstanding Section 6.1, all right, title and interest in any data or information collected by Core Direction independently and without access to, reference to or use of any of Your Data, including, without limitation, any data or information Core Direction obtains about End Users through the Core Direction Web-app (whether the same as Your Data or otherwise), will be solely owned by Core Direction (collectively, “<strong>Core Direction Data</strong>”). Core Direction reserves all rights to Aggregated Data.
            </li>
            <li class="section-title-item">
              Core Direction reserves all rights to Aggregated Data.
            </li>
            <li class="section-title-item">
              <strong>Aggregated Data</strong>. You agree Core Direction owns all Aggregated Data. You also agree that nothing in this Agreement will prohibit Core Direction or its affiliates from utilizing Aggregated Data for any purpose, provided such Aggregated Data does not reveal any personally identifying information about you or any End Users or is reasonably linkable to any End User or household.
            </li>
            <li class="section-title-item">
              Our Privacy Policy covers how we collect and use personal information.
            </li>
            <li class="section-title-item">
              <strong>Personal Information</strong>. Our <a class="external-link" href="#" target="_blank" rel="noopener noreferrer">Privacy Policy</a> governs how we collect and use personal information that is submitted through the Services. By accessing or using the Services, you agree that you have read and accept our <a class="external-link" href="#" target="_blank" rel="noopener noreferrer">Privacy Policy</a>. Without limitation, you acknowledge and agree that Core Direction may process Your Data for the purpose of providing the Services and related functions, such as billing and customer or End User support, as well as to send direct marketing communications to your representatives’ or End Users, data science and product or service improvement and reporting. You represent and warrant that You are authorized to process Your Data and make such data available to Core Direction for uses as set out in the Agreement and Privacy Policy, including through appropriate notice, consent and by your referring individuals, such as End Users, to our Privacy Policy (notwithstanding Core Direction’s ability and right, to which You agree, to request consent, and provide notice and its Privacy Policy separately to individuals).
            </li>
            <li class="section-title-item">
              You must notify us if you are subject to HIPAA and sign a BAA agreement.
            </li>
            <li class="section-title-item">
              <strong>HIPAA</strong>. The Health Insurance Portability and Accountability Act of 1996 ("HIPAA") imposes rules to protect certain personal health information or “PHI” as that term is defined under HIPAA. If you or any Affiliate is subject to HIPAA and providing or processing any PHI in connection with the Services, prior to accessing or using the Services you must notify Core Direction and enter into a Business Associate Agreement (“<strong>BAA</strong>”) in the form provided by Core Direction. You are solely responsible for determining whether you or any Affiliates are subject to HIPAA. You may send notice and request a BAA by submitting a <a class="external-link" href="https://support.coredirection.com/s/contactsupport" target="_blank" rel="noopener noreferrer">Support Request</a>.
            </li>
            <li class="section-title-item">
        ...
        <div id="section-08">
          ...
          <ul class="section-title-list">
            ...
            <li class="section-title-item">
              <strong>Right to Terminate or Suspend Services</strong>. We may suspend or terminate your access to and use of the Services (or any portion thereof) at any time without notice if we believe (a) that any activity or use of Services in connection with your account violates this Agreement, the intellectual property rights of a third party or applicable laws, or is otherwise disruptive or harmful to Core Direction or any third party, (b) that we are required to do so by law, or (c) where the Parties do not agree on the use of a sub-processor.
            </li>
          </ul>
        </div>
        <div id="section-09">
        ...
        <div id="section-11">
          ...
          <ul class="section-title-list">
            <li class="section-title-item">
              Core Direction EXPRESSLY DISCLAIMS ANY AND ALL LIABILITY AND WILL NOT BE RESPONSIBLE FOR ANY DAMAGES OR LOSS CAUSED, OR ALLEGED TO BE CAUSED, BY THE TRANSMISSION OF CARDHOLDER DATA PRIOR TO ITS ENCRYPTION AND RECEIPT BY SERVER(S) OWNED OR CONTROLLED BY Core Direction. THE EXCLUDED DAMAGES WILL INCLUDE, WITHOUT LIMITATION, DAMAGES RESULTING FROM FRAUD, EMBEZZLEMENT, THEFT, IDENTITY THEFT, OR INVASION OF PRIVACY.
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT WILL THE Core Direction PARTIES’ AGGREGATE LIABILITY, COLLECTIVELY, FOR ALL CLAIMS ARISING OUT OF OR RELATED TO THIS AGREEMENT, WHETHER IN CONTRACT, TORT OR OTHERWISE, EXCEED THE SUBSCRIPTION FEES ACTUALLY PAID BY YOU DURING THE TWELVE (12) MONTH PERIOD IMMEDIATELY PRECEDING THE DATE OF THE INCIDENT OR $100.00 (USD), WHICHEVER IS GREATER. ALL LIMITATIONS OF LIABILITY OF ANY KIND (INCLUDING IN THIS SECTION AND ELSEWHERE IN THIS AGREEMENT) APPLY WITH RESPECT TO BOTH Core Direction AND THE Core Direction PARTIES.<br>
              IN NO EVENT WILL ANY Core Direction PARTIES HAVE ANY LIABILITY FOR ANY INDIRECT, SPECIAL, INCIDENTAL, CONSEQUENTIAL OR PUNITIVE DAMAGES, HOWEVER CAUSED, OR FOR ANY LOST PROFITS, LOSS OF USE, DATA OR OPPORTUNITIES, COST OF DATA RECONSTRUCTION, COST OR PROCUREMENT OF SUBSTITUTE GOODS OR SERVICES, WHETHER IN CONTRACT, TORT OR OTHERWISE, ARISING OUT OF, OR IN ANY WAY CONNECTED WITH THE SERVICES OR THIRD PARTY OFFERINGS, INCLUDING BUT NOT LIMITED TO THE USE OR INABILITY TO USE THE SERVICES, ANY INTERRUPTION, INACCURACY, ERROR OR OMISSION, EVEN IF Core Direction, ITS LICENSORS OR SUBCONTRACTORS HAVE BEEN PREVIOUSLY ADVISED OF THE POSSIBILITY OF SUCH LOSS OR DAMAGES.
        ...
        <div id="section-13">
          ...
          <ul class="section-title-list">
            <li class="section-title-item">
              Core Direction respects the intellectual property rights of others and will investigate and respond to notices of alleged infringement that are properly submitted in accordance with our Intellectual Property Policy accessible at <a class="external-link" href="#" target="_blank">/legal/terms-of-service/intellectual-property-policy</a> (or such other URL as specified by Core Direction), as may be updated by Core Direction from time to time. Any data or information submitted to the Services is subject to our Intellectual Property Policy.
            </li>
          </ul>
        </div>
        <div id="section-14">
          ...
          <ul class="section-title-list">
            <li class="section-title-item">
              <strong>Governing Law</strong>. This Agreement will be governed by and interpreted in accordance with the internal laws of the United Arab Emirates without regard to conflicts of laws principles. The U.N. Convention on the International Sale of Goods will not apply.
            </li>
            <li class="section-title-item">
            ...
            <li class="section-title-item">
              <strong>Mandatory Informal Dispute Resolution</strong>. If you have any dispute with Core Direction arising out of or relating to this Agreement, you agree to notify Core Direction in writing with a brief, written description of the dispute and your contact information, and Core Direction will have thirty (30) days from the date of receipt within which to attempt resolve the dispute to your reasonable satisfaction. If the Parties are unable to resolve the dispute through good faith negotiations over such thirty (30) day period under this informal process, either Party may pursue resolution of the dispute in accordance with the arbitration agreement below.
            </li>
            <li class="section-title-item">
            ...
            <li class="section-title-item">
              <strong>Arbitration Agreement</strong>. ALL DISPUTES ARISING OUT OF OR RELATED TO THIS AGREEMENT OR ANY ASPECT OF THE RELATIONSHIP BETWEEN YOU AND Core Direction, WHETHER BASED IN CONTRACT, TORT, STATUTE, FRAUD, MISREPRESENTATION OR ANY OTHER LEGAL THEORY, THAT ARE NOT RESOLVED PURSUANT TO SECTION 14.2 ABOVE WILL BE RESOLVED THROUGH FINAL AND BINDING ARBITRATION BEFORE A NEUTRAL ARBITRATOR INSTEAD OF IN A COURT BY A JUDGE OR JURY, AND Core Direction AND YOU EACH HEREBY WAIVE THE RIGHT TO TRIAL BY A JURY. YOU AGREE THAT ANY ARBITRATION UNDER THIS AGREEMENT WILL TAKE PLACE ON AN INDIVIDUAL BASIS; CLASS ARBITRATIONS AND CLASS ACTIONS ARE NOT PERMITTED AND YOU ARE AGREEING TO GIVE UP THE ABILITY TO PARTICIPATE IN A CLASS ACTION. The arbitration will be administered by the American Arbitration Association under its Commercial Arbitration Rules and Mediation Procedures (currently accessible at <a class="external-link" href="https://www.adr.org/sites/default/files/Commercial-Rules-Web.pdf" target="_blank" rel="noopener noreferrer">https://www.adr.org/sites/default/files/Commercial-Rules-Web.pdf</a>) as amended by this Agreement. Any arbitration hearing will be held in Dubai, United Arab Emirates. The applicable governing law will be as set forth in Section 14.1 (provided that with respect to arbitrability issues, federal arbitration law will govern). The arbitrator’s decision will follow the terms of this Agreement and will be final and binding. The arbitrator will have authority to award temporary, interim or permanent injunctive relief or relief providing for specific performance of this Agreement, but only to the extent necessary to provide relief warranted by the individual claim before the arbitrator. The award rendered by the arbitrator may be confirmed and enforced in any court having jurisdiction thereof.
            </li>
            <li class="section-title-item">
          ...
          <p class="sidebar-item-content-desc">
            <strong>Core Direction Entity</strong>. The table below sets forth the Core Direction entity you have entered into this Agreement with (“<strong>Core Direction Entity</strong>”) depending on where you are domiciled:
          </p>
          <ul class="section-title-list">
            <li class="section-title-item">
            ...
            <li class="section-title-item">
              <strong>Assignment</strong>. You may not assign, delegate or transfer this Agreement in whole or in part, without Core Direction’s prior written consent. Core Direction may assign, transfer or sublicense any or all of Core Direction’s rights or obligations under this Agreement without restriction.
            </li>
            <li class="section-title-item">
            ...
            <li class="section-title-item">
              <strong>Relationship of the Parties</strong>. This Agreement does not, and will not be construed to, create any partnership, joint venture, employer-employee, agency or franchisor-franchisee relationship between you and Core Direction.
            </li>
          </ul>
        </div>
        <div id="section-15">
          ...
          <p class="sidebar-item-content-desc">
            <strong>“Aggregated Data”</strong> means anonymized, de-identified, or aggregated data derived by or through the operation of the Services that is created by or on behalf of Core Direction in compliance with applicable laws and that does not reveal any personally identifying information about you or any End Users or is reasonably linkable to any End User or household.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“API”</strong> means Core Direction’s application programming interface that is described at <a class="external-link" href="https://developers.coredirection.com" target="_blank" rel="noopener noreferrer">https://developers.coredirection.com</a> (or such other URL as specified by Core Direction), as may be updated by Core Direction from time to time, and any subsequent application programming interfaces that are developed and made available by Core Direction to interact with or otherwise be used in connection with the Services.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“Apps”</strong> means any mobile applications through which Core Direction makes the Software Service available, including, but not limited to, the Core Direction business app and the Core Direction White Labeled Web-app.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“Cardholder Data”</strong> means credit card numbers, expiration dates, billing addresses, and cardholder names as entered by End Users and you. Cardholder Data is a subset of End User Data.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>"Confidential Information"</strong> means (a) any software utilized by Core Direction in the provision of the Services and its respective source code; (b) each Party’s business or technical information, including but not limited to the Documentation, information relating to software plans, designs, costs, prices and names, business opportunities, personnel, research, development or know-how that is designated by the disclosing Party as “confidential” or “proprietary” or the receiving Party knows or should reasonably know is confidential or proprietary; and (c) any special pricing or other non-standard terms agreed to by the Parties in an Order Form or other separate written document.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“Documentation"</strong> means online user guides, documentation, and help and training materials, as may be updated by Core Direction from time to time, accessible at the applicable Website(s), and any other materials provided by Core Direction as part of the Services.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“End User”</strong> means a business or individual that schedules or purchases products or services from you through the Services, that you market to, communicate with, or target through the Services, or that otherwise interacts with you through the Services, or that you authorize to use the Services in connection with your business.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“End User Data”</strong> means all data, information or other material about an End User that you, an Affiliate or End User provides or submits to the Services. End User Data may include Cardholder Data and such portions of Your Data that relates to specific End Users.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“Franchise Fees Tool”</strong> means the Service which enables you to collect funds from a Franchisee and/or Affiliate.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“Franchisee”</strong> means any party that is bound by a franchise agreement with you, and that you have designated to receive Services under this Agreement. Franchisees are bound by the terms of this Agreement as if they were an original party hereto.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“HIPAA”</strong> means the Health Insurance Portability and Accountability Act, as amended and supplemented.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“Marketing Services”</strong> means Core Direction’s online marketing platform, which allows consumers to locate Core Direction subscribers and evaluate, review and book their services, directly through the Core Direction App and through our partner applications.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“Core Direction Web-app”</strong> means <a class="external-link" href="https://coredirection.com" target="_blank" rel="noopener noreferrer">https://coredirection.com</a> (or such other URL as specified by Core Direction), as may be updated by Core Direction from time to time as well as the consumer-facing, downloadable mobile app made available by Core Direction and known as the “Core Direction Web-app” (and its successor products), which allows consumers to use their mobile devices to find, book and pay for the services of participating Core Direction subscribing businesses.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“Core Direction Marks”</strong> means all service marks, logos and product and service names used, applied for, registered, or otherwise owned by Core Direction and its affiliates.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“Order Form”</strong> means a separate ordering document, invoice, online form, or other documentation that specifies the Services ordered or purchased hereunder, the applicable Software Fees (or if the Services are free), and other terms as agreed to between the Parties. If an Order Form indicates that any Affiliates or Franchisees will be receiving Services hereunder, each of them will be bound by the terms of this Agreement as if they were an original party hereto.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“Partner Store”</strong> means the Core Direction partner store which provides you the ability to search Third Party Offerings. The Core Direction Partner Store is accessible at <a class="external-link" href="#" target="_blank" rel="noopener noreferrer">https://partnerstore.coredirection.com/</a> (or such other URL as specified by Core Direction), as may be updated by Core Direction from time to time.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“PCI DSS”</strong> means the requirements of the Payment Card Industry Data Security Standard, as detailed on <a class="external-link" href="https://www.pcisecuritystandards.org/" target="_blank" rel="noopener noreferrer">https://www.pcisecuritystandards.org/</a>, and as may be updated from time to time.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“Professional Services”</strong> means Core Direction’s supplemental, fee-based technical support services described at <a class="external-link" href="#" target="_blank" rel="noopener noreferrer">https://business.coredirection.com/professional-services</a> (or such other URL as specified by Core Direction), as may be updated by Core Direction from time to time.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“Privacy Policy”</strong> means the Core Direction <a class="external-link" href="#" target="_blank" rel="noopener noreferrer">Privacy Policy</a> accessible at <a class="external-link" href="#" target="_blank" rel="noopener noreferrer">/legal/privacy-policy</a> (or such other URL as specified by Core Direction), as may be updated by Core Direction from time to time.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“Services”</strong> means the Software Services, Website, Apps, hardware and other services. “Services” excludes Third Party Offerings and our Core Direction Web-app.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“Software Service”</strong> is defined in the Introduction.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“Third Party Offerings”</strong> means any third party products, applications, websites, implementations or services, including loyalty programs, that the Services link to, or that interoperate with or are used in conjunction with the Services.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“Virtual Wellness Platform”</strong> or <strong>“VWP”</strong> means the Core Direction virtual wellness platform which provides you the ability to upload video on demand and live stream video offerings for use by consumers using the Core Direction Web-app, White Labeled Web-app, and/or such other platforms as designated by Core Direction.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“Website”</strong> means <a class="external-link" href="https://www.coredirection.com" target="_blank" rel="noopener noreferrer">https://www.coredirection.com</a>, (or such other URLs as specified by Core Direction), as may be updated by Core Direction from time to time and any other websites through which Core Direction makes the Software Service available.
          </p>
          <p class="sidebar-item-content-desc">
            <strong>“Your Data”</strong> means any data, information or material provided or submitted or made available by you and Affiliates to the Services. Your Data may include End User Data and Cardholder Data (and your or their representative’s data), but excludes Aggregated Data.
          </p>
        </div>
      </div>
    </div>
