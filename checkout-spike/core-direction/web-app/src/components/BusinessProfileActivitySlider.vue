<template>
  <div v-if="sliderData.length > 0" class="section-body">
    <booking-modal
      v-if="showModal"
    ...
    <SocialSharingOnSignup :show-modal="showSharingModal" :slugUrl="$route.params.slug" @setShowActivityModal="hideSocialSharingModal" />
      ...
      <swiper ref="mySwiper" :options="swiperOptions">
        ...
        <swiper-slide>
          <div class="btn-package-detail-wrap">
            <a class="btn-browse-more" href="#activities">
...
export default {
  name: "BusinessProfileActivitySlider",
