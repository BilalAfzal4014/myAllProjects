...
module.exports = class BaseMailer {
    ...
    getRenderedFileFromTemplatingEngine() {
        return EjsHelper.renderFileFromGivenPath(this.htmlFilePath, this.dataForHtmlTemplate)
    ...
    prepareDateForSendingHtmlTemplate() {
        console.log("parent mocked prepareDateForSendingHtmlTemplate");
    }

    sendEmails() {
        return Promise.resolve([this.emailPayLoad]);
    }
}